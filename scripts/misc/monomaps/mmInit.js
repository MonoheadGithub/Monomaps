// I'm redoing this garbage; please ignore this junk.
...
async function init() {
  try {
    ...
    if (!mapMode) {
      ...
      localStorage.setItem("mapMode", "Paralake");
      ...
      if (mapMode === "Southside") {
        ...
        localStorage.setItem("timeMode", "Layer1");
        window.location.reload();
      } else if (mapMode === "Paralake") {
        document.getElementById("monomaps-maps-maparea").style.background =
          'url("./assets/monomaps/backgrounds/paralake.png")';
        mapareaSize(2048);
        document.getElementById("mapInfo").innerHTML = `Paralake by Perpheads`;
      }
    }
